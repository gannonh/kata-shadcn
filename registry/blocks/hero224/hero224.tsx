...
const Hero224 = ({ className }: Hero224Props) => {
  ...
  return (
    <section className={cn("py-32", className)}>
      <div className="container flex w-full flex-col items-center justify-between md:h-150 md:flex-row md:overflow-hidden">
        <div>
          <h1 className="relative z-99 max-w-md text-6xl font-medium tracking-tight md:text-7xl">
            Search, <br /> Copy, Paste
            <br /> Build
          </h1>
          <p className="relative z-99 mt-4 max-w-lg text-lg text-muted-foreground">
