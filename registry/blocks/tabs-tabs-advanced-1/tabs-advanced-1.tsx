  ...
  <Tabs className="w-full max-w-2xl" defaultValue="inbox">
    ...
    <TabsContent value="inbox">
      <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
        <h3 className="mb-4 text-lg font-semibold">Inbox (12)</h3>
    ...
    <TabsContent value="unread">
      <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
        <h3 className="mb-4 text-lg font-semibold">Unread Messages (5)</h3>
        <div className="space-y-3">
          {Array.from({ length: 2 }).map((_, i) => (
            <div className="rounded-md border p-4" key={i}>
              <div className="mb-2 flex items-start justify-between">
                <div>
                  <p className="text-sm font-medium">Unread Message {i + 1}</p>
                  <p className="text-xs text-muted-foreground">
                    sender{i + 1}@example.com
                  </p>
                </div>
    ...
    <TabsContent value="archived">
      <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
        <h3 className="mb-4 text-lg font-semibold">Archived Messages (48)</h3>
        <p className="text-sm text-muted-foreground">
    ...
    <TabsContent value="spam">
      <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
        <h3 className="mb-4 text-lg font-semibold">Spam Messages (3)</h3>
        <p className="text-sm text-muted-foreground">
